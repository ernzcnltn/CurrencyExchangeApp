...
@dso_cache = dso_local local_unnamed_addr global [40 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.0_name, ; name: libSkiaSharp.so
		ptr null; void* handle (0x0)
	}, ; 2
	%struct.DSOCacheEntry {
...
@.env.7 = private unnamed_addr constant [37 x i8] c"cec59d23-d9a3-44b6-876a-140790c5cdec\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [36 x i8] c"com.companyname.currencyexchangeapp\00", align 16

;DSOCacheEntry
@.DSOCacheEntry.0_name = private unnamed_addr constant [16 x i8] c"libSkiaSharp.so\00", align 16
